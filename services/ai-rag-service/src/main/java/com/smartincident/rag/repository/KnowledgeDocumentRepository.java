...
public interface KnowledgeDocumentRepository extends JpaRepository<KnowledgeDocument, Long> {
   ...
   */
  @Query(value = """
      SELECT id, title, content, doc_type, source_id, tags, CAST(embedding AS text) AS embedding, created_at, updated_at
  ...
  /**
   * Native insert to handle vector casting.
   */
  @Query(value = "INSERT INTO ai_rag.knowledge_documents (title, content, doc_type, source_id, tags, embedding, created_at, updated_at) "
      +
      "VALUES (:title, :content, :#{#docType?.name()}, :sourceId, :tags, CAST(:embedding AS vector), NOW(), NOW()) " +
